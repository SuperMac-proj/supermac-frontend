...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    changes: [
      {
        type: 'new',
        description: 'Initial release of SuperMac - Your Mac productivity toolkit',
      },
      {
        type: 'new',
        description: 'Clipboard History: Unlimited history with text and image support',
      },
      {
        type: 'new',
        description: 'Text Snippets: Expand shortcuts into full phrases with Tab/Space',
      },
      {
        type: 'new',
